...
public class MainApplication {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (Food item : breakfast) {
            if (item != null) {
                System.out.println(item);  // Вывод объекта на экран (используется метод toString())
            } else {
                break;  // Прерываем цикл, если дошли до пустого элемента
            }
        }
